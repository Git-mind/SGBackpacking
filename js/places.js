...
cardComp = Vue.component('include-cards', {
...
function mainVue(userUid) {
    ...
    const searchPage = new Vue({
        ...
        data: {
            cards: '',
            warning: '',
            // apiKey: 'A4dcssGA4035eGJbqZVu6vCcNqelWle1',
            apiKey: 'gqEhTezI2IpDZsabACjEg3RoXcPhXw9k',

            proxyServer: 'https://lingering-butterfly-c754.scaper65.workers.dev/?',
            //placeholder image
            placeImage: "../resource/singapore.jpg",
            //place url 
            placeURL: "https://tih-api.stb.gov.sg/content/v1/attractions/search?filtersource=stb",
        ...
        methods: {
            ...
            //tabs click event 
            tabEvent: function (place) {
                this.warning = ''
                this.keyword = 'Popular'
                if (place == 'a') {
                    this.sendPlace = 'att'
                    this.placeURL = "https://tih-api.stb.gov.sg/content/v1/attractions/search?filtersource=stb"
                    this.keyword = 'popular'
                    this.isAttraction = true
                    this.isBarClub = false
                    this.isFoodBev = false

                } else if (place == 'b') {
                    this.sendPlace = 'bar'
                    this.placeURL = "https://tih-api.stb.gov.sg/content/v1/bars-clubs/search?filtersource=stb"
                    ...
                    this.sendPlace = 'foo'
                    this.placeURL = "https://tih-api.stb.gov.sg/content/v1/food-beverages/search?filtersource=stb"
                    this.isAttraction = false
                    this.isBarClub = false
                    this.isFoodBev = true
